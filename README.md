...
| Тип данных                         | Формула расчёта **на 1 пользователя**                               | Общий объём данных                  |
| :--------------------------------- | :------------------------------------------------------------------ | :---------------------------------- |
| **Информация о местах (POI)**      | 1.17 просмотров × 365 × 5 КБ = **2135 КБ ≈ 2.1 МБ**                 | 2.1 МБ × 20 000 000 = **≈42 ТБ**    |
| **Картографические данные (OSM)**  | 85 ГБ ÷ 60 000 000 пользователей = **≈1.45 МБ**                     | 1.45 МБ × 20 000 000 = **≈29 ТБ**   |
| **Кэш тайлов карты**               | 1.7 открытий карты × 365 × 4 тайла × 8 КБ = **19 856 КБ ≈ 19.4 МБ** | 19.4 МБ × 20 000 000 = **≈388 ТБ**  |
| **Логи пользовательских действий** | 365 × 250 Б = **91 250 Б ≈ 0.087 МБ**                               | 0.087 МБ × 20 000 000 = **≈1.7 ТБ** |
| **Итого**                          | **≈23 МБ на пользователя**                                          | **≈460 ТБ**                         |
---
