...
| `tile_cache` |  CDN | Тайлы карты читаются очень часто, поэтому их выгодно хранить в кэше и раздавать через CDN; для долговременного хранения подходит объектное хранилище |
