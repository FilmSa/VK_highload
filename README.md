...
NGINX основное L7-прокси способно обрабатывать высокий объём HTTPS-трафика; для нашей нагрузки в **13 тыс. rps** ограничение по SSL termination не является критичным.
