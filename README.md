...
- `tiles.2gis.com` - **тайлы карты**
- `api.2gis.com` - **поиск + карточки организаций**
- `route.2gis.com` - **маршрутизация**
- `cdn.2gis.com` - **офлайн-пакеты**
- `2gis.com` - **основной сайт**
...
## 3.5 Схема Anycast балансировки (при наличии)
