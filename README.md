...
| Таблица         | Описание                    | Размер записи (байт) | Число записей |   Объём | Нагрузка на запись (QPS, пик) | Нагрузка на чтение (QPS, пик) |
| --------------- | --------------------------- | -------------------: | ------------: | ------: | ----------------------------: | ----------------------------: |
| category        | Категории организаций       |                   60 |            1K |   60 KB |                             1 |                          1840 |
| city            | Города                      |                  100 |          1118 | ~110 KB |                             1 |                          1720 |
| organization    | Карточки организаций        |                  300 |           22M | ~6.6 GB |                            70 |                          2350 |
| Point           | Филиалы (адрес, координаты) |                  220 |           33M | ~7.3 GB |                           120 |                          2700 |
| user_account    | Пользователи                |                  180 |           20M |  3.6 GB |                            72 |                          1910 |
| review          | Отзывы                      |                  180 |          100M |   18 GB |                           215 |                          2260 |
| Thematic layers | Дорожный граф / маршруты    |                   90 |          200M |   18 GB |                            43 |                          1185 |
| tile_cache      | Кэш тайлов                  |                   70 |          500M |   35 GB |                          1120 |                          3470 |
