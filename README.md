...
| **Object Storage (S3)**    | Тайлы карты, офлайн-пакеты, статические данные                                                                                   | резервная репликация в backup-хранилище                                | Обеспечение высокой доступности и отказоустойчивости без необходимости классического бэкапа       |
